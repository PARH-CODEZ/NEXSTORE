      ...
      <div className='overflow-x-hidden'>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-6">
              ...
              <ProfileField
                ...
                onChange={(val) => setUserInfo(prev => ({ ...prev, email: val }))}
                onEdit={() => handleUserInfoEdit('email')}
                onSave={saveChanges}
                setEditingField={setEditingField}
                hint="FOR STRONGER ACCOUNT SECURITY, ADD YOUR EMAIL. IF THERE'S AN UNUSUAL SIGN-IN, WE'LL EMAIL YOU AND VERIFY THAT IT'S REALLY YOU."
              ...
              <ProfileField
                ...
                onSave={saveChanges}
                setEditingField={setEditingField}
                hint="  QUICKLY SIGN IN, EASILY RECOVER PASSWORDS AND RECEIVE SECURITY NOTIFICATIONS WITH THIS MOBILE NUMBER."
              />
              ...
              <div className=" py-4 border-b border-gray-200 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 uppercase tracking-wide">YOUR ADDRESSES</h2>
                </div>
                <button
                ...
                {addresses.map((address) => (
                  <div key={address.AddressID} className="border border-gray-200 rounded-lg p-4 relative">
                    ...
                    <div className="text-gray-900  mb-2">
                      <div className="font-medium text-xl uppercase">{address.AddressLine1}</div>
                      {address.AddressLine2 && <div className='text-xl'>{address.AddressLine2}</div>}
                      <div className='text-xl'>{address.City}, {address.State} {address.PostalCode}</div>
                      <div className='text-xl uppercase'>{address.Country}</div>
                    </div>
        ...
        <div className="flex justify-center my-8">
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-semibold px-15 py-3 rounded uppercase"
          >
            Logout
          </button>
        </div>
    ...
    <div className="flex justify-between items-center py-4 border-b border-gray-100">
      <div className="flex-1">
        <div className="flex items-center mb-2">
          {icon}
          <label className="text-xl font-medium text-gray-900 uppercase tracking-wide">{label}</label>
        </div>
        {isEditing ? (
          <input
  ...
  return (
    <div className="flex justify-between items-center py-4 border-b border-gray-100">
      <div className="flex-1">
        <div className="flex items-center mb-2">
          {icon}
          <label className="text-xl font-medium text-gray-900 uppercase tracking-wide ml-2">{label}</label>
        </div>
