...
import {
    Search, Filter, Download, Eye, Package, Truck, CheckCircle, XCircle, Clock, AlertCircle, ChevronDown, ChevronLeft,
    ChevronRight, MoreHorizontal, Mail, Phone, MapPin, Calendar, DollarSign, ArrowUpCircle, ShoppingBag, MoveRight
} from "lucide-react";
...
const OrderManagement = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                setLoading(true);
                const res = await fetch(`/api/orders/adminorders?page=${currentPage}&limit=${itemsPerPage}`, {
                    credentials: 'include',
                });
                                                                    ...
                                                                    <div className="flex items-start justify-between">
                                                                        <div className="flex-1">
                                                                            ...
                                                                            <div className="mt-1 text-xs text-gray-500 uppercase">
                                                                                Seller ID: <span className="font-semibold">{product.sellerId ?? "N/A"}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
