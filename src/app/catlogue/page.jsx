  ...
  setUploadingImages(false);
    ...
    const addAttribute = (attributeId, value) => {
        ...
        setCurrentVariant(prev => ({
            ...prev,
            attributes: [
                ...prev.attributes.filter(attr => attr.attributeId !== parseInt(attributeId)),
                { attributeId: parseInt(attributeId), attributeName: attribute.name, value }
            ]
        }));
    };
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div className='flex  sm:ml-11 md:ml-0 flex-row md:justify-end items -center space-x-4 sm:justify-between'>
                            <button
                                ...
                                className="mt-4 w-[140px] md:mt-0 inline-flex items-center justify-center px-4 py-2 bg-white text-black font-semibold rounded-md hover:bg-blue-700 transition"
                            >
                            ...
                            <button
                                ...
                                className="mt-4 w-[140px] md:mt-0 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition"
                            >
                                <Plus size={18} className="mr-2" />
                                ADD CATEGORY
                            </button>
                                    ...
                                    {availableAttributes.map(attr => (
                                        <div key={attr.id}>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => e.target.value && addAttribute(attr.id, e.target.value)}
