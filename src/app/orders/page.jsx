...
import { Package, Truck, CheckCircle, Clock, Search, Filter, ChevronDown, Star, ArrowRight } from 'lucide-react';
                            ...
                            <div className="space-y-4">
                                {filteredOrders.map((order) => (
                                    <div key={order.id} className="bg-white rounded-lg shadow-xl border border-gray-300 overflow-hidden">
                                        ...
                                        {/* Order Status Button (instead of full order status panel) */}
                                        <div className="px-6 py-3 bg-white border-t border-gray-200">
                                            <button
                                                onClick={() => router.push(`/checkout/success?orderId=${order.id}`)}
                                                className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2 border border-blue-600 text-sm font-medium text-blue-600 rounded-md hover:bg-blue-50 transition-all uppercase"
                                            >
