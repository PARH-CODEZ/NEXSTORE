    ...
    <section className="min-h-[calc(100vh)] w-full flex items-center justify-center bg-white p-6">
      <div className="w-full max-w-md text-center bg-gray-100 p-8 px-10">
        ...
        <div className="space-y-3">
          <Link
            href="/"
            className="uppercase inline-flex items-center justify-center gap-2 w-full max-w-xs mx-auto px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-md transition-colors duration-200"
          >
          ...
          <button
            ...
            className="uppercase inline-flex items-center justify-center gap-2 w-full max-w-xs mx-auto px-6 py-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-md transition-colors duration-200"
          >
