...
const ProductCards = () => {
  ...
  return (
    <div className="max-w-full mx-auto p-5 bg-gray-300  min-h-screen 2xl:max-w-[80%] 2xl:mt-[-550px] xl:mt-[-360px] lg:mt-[-240px] md:mt-[-200px] mt-[-120px] z-[9999] ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-8 ">
        {cardData.map((card) => (
          ...
          >
            <h3 className="text-md md:text-md font-semibold text-gray-900 mb-4 leading-tight uppercase">
              {card.title}
            </h3>
